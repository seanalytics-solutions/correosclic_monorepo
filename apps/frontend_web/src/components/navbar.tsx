    ...
    <div className="sticky top-0 z-50 bg-white shadow-md flex items-center justify-between w-full px-2 sm:px-3 md:px-4 py-2">
      ...
      <div className="flex items-center gap-1 sm:gap-2 md:gap-3">
        ...
        <DropdownMenu
          ...
          onOpenChange={(open) =>
            open ? handleDropdownToggle("menu") : handleDropdownClose()
          }
        >
          ...
          <DropdownMenuContent
            align="start"
            className="w-[280px] sm:w-[300px] max-h-[400px] sm:max-h-[450px] overflow-y-auto"
          >
            {categories.map((category, index) => (
              <DropdownMenuItem
                key={index}
                className="first:mb-4 sm:first:mb-6 last:mt-4 sm:last:mt-6 [&:not(:first-child):not(:last-child)]:my-4 sm:[&:not(:first-child):not(:last-child)]:my-6 text-sm sm:text-base"
              >
                <Link
      ...
      <div className="flex items-center gap-x-1 sm:gap-x-2">
        ...
        <DropdownMenu
          ...
          onOpenChange={(open) =>
            open ? handleDropdownToggle("app") : handleDropdownClose()
          }
        >
          ...
          <DropdownMenuContent
            align="end"
            className="w-[280px] sm:w-[300px] p-3 sm:p-4"
          >
            <div className="flex-col">
              <div className="text-lg sm:text-xl font-semibold text-center">
                Descárgalo en móvil
              </div>
              <div className="text-black/50 text-xs sm:text-sm mt-1">
                Escanee con la cámara de su teléfono o la aplicación de código
                QR para descargarlo
              </div>
            </div>
            <div className="p-2 sm:p-3 mt-2">
              <Image
                ...
                width={150}
                height={150}
                className="w-full h-full max-w-[120px] sm:max-w-[150px] mx-auto"
              />
            </div>
          </DropdownMenuContent>
        </DropdownMenu>
        ...
        {/* Favoritos */}
        <DropdownMenu
          open={openDropdown === "favorites"}
          onOpenChange={(open) =>
            open ? handleDropdownToggle("favorites") : handleDropdownClose()
          }
        >
          <DropdownMenuTrigger className="p-2 flex items-center justify-center hover:bg-gray-100 rounded-full text-gray-600 bg-[#F3F4F6] min-h-[40px] min-w-[40px] sm:min-h-[45px] sm:min-w-[45px] md:min-h-[51px] md:min-w-[54px] relative">
            <IoHeartOutline
              className={`w-4 h-4 sm:w-5 sm:h-5 ${totalFavorites > 0 ? "hidden" : "block"}`}
            />
            <IoHeartSharp
              className={`w-4 h-4 sm:w-5 sm:h-5 text-red-600 ${totalFavorites > 0 ? "block" : "hidden"}`}
            />
            <span
              className={`absolute -top-1 -right-1 bg-red-500 text-white text-xs rounded-full w-4 h-4 flex items-center justify-center ${totalFavorites > 0 ? "block" : "hidden"}`}
            >
              {totalFavorites}
            </span>
          </DropdownMenuTrigger>
          <DropdownMenuContent
            align="end"
            className="w-[320px] sm:w-[350px] p-3 sm:p-4 overflow-y-auto max-h-[350px] sm:max-h-[400px]"
          >
            <div className="flex-col">
              <div className="flex items-center">
                ...
                <Link
                  href={"/favoritos"}
                  className="ms-auto text-xs sm:text-sm underline"
                  onClick={handleDropdownClose}
                >
                  Ver favoritos
                </Link>
        ...
        {/* Carrito */}
        <DropdownMenu
          open={openDropdown === "cart"}
          onOpenChange={(open) =>
            open ? handleDropdownToggle("cart") : handleDropdownClose()
          }
        >
          <DropdownMenuTrigger className="p-2 flex items-center justify-center hover:bg-gray-100 rounded-full text-gray-600 bg-[#F3F4F6] min-h-[40px] min-w-[40px] sm:min-h-[45px] sm:min-w-[45px] md:min-h-[51px] md:min-w-[54px] relative">
            <IoBagOutline className="w-4 h-4 sm:w-5 sm:h-5" />
          ...
          <DropdownMenuContent
            align="end"
            className="w-[340px] sm:w-[380px] p-3 sm:p-4 overflow-y-auto max-h-[400px] sm:max-h-[450px]"
          >
            <div className="flex-col">
              {/* Header */}
                        ...
                        <div className="basis-2/3 ms-2 sm:ms-3 flex flex-col justify-between text-xs sm:text-sm">
                          ...
                          <div className="flex items-center space-x-1 sm:space-x-2">
                            <span className="text-xs text-gray-500">
                              Cant: {item.prodcutQuantity}
                            </span>
                            <div
                              className={`w-2 h-2 sm:w-3 sm:h-3 rounded-full ${item.isSelected ? "bg-green-500" : "bg-gray-300"}`}
                            ></div>
                          </div>
                        </div>
                        <div className="basis-1/12 flex items-center justify-center">
        ...
        <DropdownMenu
          ...
          onOpenChange={(open) =>
            open ? handleDropdownToggle("user") : handleDropdownClose()
          }
        >
          ...
          <DropdownMenuContent
            align="end"
            className="w-[260px] sm:w-[280px] p-3 sm:p-4"
          >
            {!isSignedIn ? (
              ...
              <div className="flex-col">
                ...
                <div className="flex items-center mb-3 sm:mb-4">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-background/20 animate-pulse rounded-full flex items-center justify-center text-white font-medium mr-2 sm:mr-3 text-sm overflow-hidden" />
                  <div className="flex-col">
                    <div className="bg-background/20 animate-pulse h-8 rounded-full w-44" />
        ...
        <DropdownMenu
          ...
          onOpenChange={(open) =>
            open ? handleDropdownToggle("language") : handleDropdownClose()
          }
        >
          ...
          <DropdownMenuContent
            align="end"
            className="w-[260px] sm:w-[280px] p-2"
          >
            <div className="flex-col">
              {/* Español */}
              <div
