...
export const GOOGLE_GEOCODE_REPOSITORY_INTERFACE = Symbol("Google_Geocode_Repository_Interface");

export interface GoogleGeocodeRepositoryInterface {
    // firma para obtener la geolocalizacion
    obtenerCoordenadas(request: GeocodingRequestDto): Promise<Result<CoordenadasReadModel>>
}