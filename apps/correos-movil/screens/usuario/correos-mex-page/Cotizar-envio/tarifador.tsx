  ...
  */
  ...
  const handleCotizarInternacional = async () => {
    ...
    const MOCK_COTIZACION_INT = {
      pesoFisico: peso || 5.0,
      pesoVolumetrico: 7.8,
      tarifaSinIVA: 450.7, // Un precio internacional
      iva: 72.11,
    };
      ...
      >
        ...
        <View style={styles.titleContainer}>
          ...
          <Text style={styles.subtitle}>
            Cotiza los precios de tus envíos de forma fácil con nuestro
            tarificador.
          </Text>
        </View>
              ...
              {activeTab === "Nacional" && datosEnvio && (
                <View style={styles.resultsCard}>
                  ...
                  <View style={styles.resultsInfoRow}>
                    ...
                    <Text style={styles.resultsInfoValue}>
              ...
              {!showQuote && (
                <View style={styles.dimensionsSection}>
                  ...
                  >
                    {loadingQuote ? (
                      <ActivityIndicator
                        color={styles.activeTab.backgroundColor}
                      />
                    ) : (
                      <>
                        <Ionicons
              ...
              {showQuote && cotizacionData && (
                <View style={styles.quoteSection}>
                  ...
                  {(() => {
                    ...
                    const COSTO_ACUSE_SIMULADO = 50.0;
                    const COSTO_SEGURO_SIMULADO = 80.0;
                        ...
                        <View style={styles.detallesContainer}>
                          <View style={styles.detalleRow}>
                            ...
                            <Text style={styles.detalleValue}>
                              {cotizacionData.pesoFisico} kilogramos
                            </Text>
                          </View>
                          <View style={styles.detalleRow}>
                            <Text style={styles.detalleLabel}>Volúmen:</Text>
                            <Text style={styles.detalleValue}>
                              {cotizacionData.pesoVolumetrico} kilogramos
                            </Text>
                          </View>

                          {/* Filas Seleccionables (Checkboxes) */}
                          <TouchableOpacity
                            style={styles.detalleRowCheckbox}
                            onPress={() => setIncluirAcuse(!incluirAcuse)}
                          >
                            <Text style={styles.detalleLabel}>
                              Acuse de recibo
                            </Text>
                          ...
                          <TouchableOpacity
                            style={styles.detalleRowCheckbox}
                            onPress={() => setIncluirSeguro(!incluirSeguro)}
                          >
                          ...
                          <View style={styles.detalleRow}>
                            ...
                            <Text style={styles.detalleValue}>
                              MXN ${tarifaBase.toFixed(2)}
                            </Text>
                          </View>
                          <View style={styles.detalleRow}>
                            <Text style={styles.detalleLabel}>IVA:</Text>
                            <Text style={styles.detalleValue}>
                              MXN ${ivaBase.toFixed(2)}
                            </Text>
                          </View>
                          ...
                          {incluirAcuse && (
                            <View style={styles.detalleRowOpcional}>
                              <Text style={styles.detalleLabelOpcional}>
                                + Acuse de recibo:
                              </Text>
                              <Text style={styles.detalleValueOpcional}>
                                MXN ${COSTO_ACUSE_SIMULADO.toFixed(2)}
                              </Text>
                            </View>
                          )}
                          {incluirSeguro && (
                            <View style={styles.detalleRowOpcional}>
                              ...
                              <Text style={styles.detalleValueOpcional}>
                                MXN ${COSTO_SEGURO_SIMULADO.toFixed(2)}
                              </Text>
                            </View>
                          )}
                          ...
                          <View style={styles.costoTotalContainer}>
                            <Text style={styles.costoTotalLabel}>
                              Costo del envío:
                            </Text>
