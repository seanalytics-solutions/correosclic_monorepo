...
export default function TarifasParaEnviosDeCartas() {
     ...
     <View style={styles.safeArea}>
      ...
      <ScrollView style={styles.container}>
        ...
        <View style={styles.paragraph}>
          <Text style={styles.textCentered}>Envío masivo de cartas, documentos o tarjetas postales por todo México.</Text>
        </View>
        ...
        <View style={styles.card}>
            ...
            <View style={styles.priceContainer}>
              <View style={styles.priceBox}>
                ...
                <View style={styles.priceBoxContainer}>
                  <Text style={styles.priceFrom}>$3.24 MXN</Text>
                </View>
              ...
              <View style={styles.priceBox}>
                ...
                <View style={styles.priceBoxContainer}>
                  <Text style={styles.priceTo}>$15.95 MXN</Text>
                </View>
          ...
          <View style={styles.details}>
            <Text style={styles.bullet}>• De 500 a 10,000 piezas.</Text>
            <Text style={styles.bullet}>
              • <Text style={styles.bold}>Peso máximo:</Text> 1kg por pieza.
            </Text>
          </View>
        </View>
