      ...
      <ScrollView style={styles.container}>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.details}>
            <Text style={styles.bullet}>• De 250 a 500 piezas.</Text>
            <Text style={styles.bullet}>
              • <Text style={styles.bold}>Peso máximo:</Text> 25kg por paquete.
            </Text>
          </View>
        </View>
        ...
        <View style={styles.card}>
          ...
          {/* Detalles */}
          <View style={styles.details}>
            <Text style={styles.bullet}>• De 501 a 10,000 piezas.</Text>
            <Text style={styles.bullet}>
        ...
        <View style={styles.card}>
          ...
          {/* Detalles */}
          <View style={styles.details}>
            <Text style={styles.bullet}>• De 10,001 a 15,000 piezas.</Text>
            <Text style={styles.bullet}>
