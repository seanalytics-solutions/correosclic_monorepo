      ...
      >
        <View style={styles.titleContainer}>
          ...
          <Text style={styles.mainSubtitle}>
            Haz crecer tu negocio y lleva tus servicios a otros países enviando
            desde folletos, boletines y carteles hasta revistas, libros, gacetas
            y más.
          </Text>
        </View>
        ...
        <PriceSection
          ...
          weightText="Peso máximo: 2 kg por pieza y 5 kg para libros."
        />
        <PriceSection
